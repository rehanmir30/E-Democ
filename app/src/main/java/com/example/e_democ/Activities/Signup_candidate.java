...
public class Signup_candidate extends AppCompatActivity {
    ...
    public void goBack(View view) {
        Intent i = new Intent(Signup_candidate.this, SignupChoice.class);
        startActivity(i);
        finish();
    }
    ...
    public void next_details(View view) {
        ...
        if (v_fullname.isEmpty()) {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                Intent i = new Intent(Signup_candidate.this, Get_More_Details_Candidate.class);
